...
void write_graphics(const char* filename, float* input, int data_rows,
    int data_cols, int major, int data_range)
{
...
void read_graphics(const char* filename, float* input, int data_rows,
    int data_cols, int major)
{
